import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as i,c as o,a as n,b as s,d as p,e as l}from"./app-7115fe16.js";const c={},r=n("h1",{id:"maui",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#maui","aria-hidden":"true"},"#"),s(" maui")],-1),d=n("h2",{id:"windows-title-bar-隐藏",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#windows-title-bar-隐藏","aria-hidden":"true"},"#"),s(" windows title bar 隐藏")],-1),u={href:"http://xn--6kqwhu42f03ierdpt1c.net",target:"_blank",rel:"noopener noreferrer"},v=l(`<div class="language-csharp line-numbers-mode" data-ext="cs"><pre class="language-csharp"><code><span class="token preprocessor property">#<span class="token directive keyword">if</span> </span><span class="token return-type class-name">WINDOWS</span>
