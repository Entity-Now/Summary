import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as e,a as s}from"./app-6e366925.js";const i="/images/Conan.png",t={},l=s(`<h1 id="conan包管理工具" tabindex="-1"><a class="header-anchor" href="#conan包管理工具" aria-hidden="true">#</a> conan包管理工具</h1><h2 id="配置cmakelists-txt文件" tabindex="-1"><a class="header-anchor" href="#配置cmakelists-txt文件" aria-hidden="true">#</a> 配置CMakeLists.txt文件</h2><div class="language-cmake line-numbers-mode" data-ext="cmake"><pre class="language-cmake"><code><span class="token keyword">cmake_minimum_required</span><span class="token punctuation">(</span><span class="token property">VERSION</span> <span class="token number">3.26.0</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="配置预设" tabindex="-1"><a class="header-anchor" href="#配置预设" aria-hidden="true">#</a> 配置预设</h2><blockquote><p>需配置预设，否则vs编辑器无法打开源文件</p></blockquote><p>vs code编辑器可以按<code>ctrl+shift+p</code>输入<code>Cmake: Select Configure Preset</code> 然后选择已有的预设</p>`,21),c=[l];function d(r,o){return n(),e("div",null,c)}const v=a(t,[["render",d],["__file","conan.html.vue"]]);export{v as default};
