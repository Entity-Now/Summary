import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as e,a as s}from"./app-ba995044.js";const i="/images/Conan.png",t={},l=s(`<h1 id="conan包管理工具" tabindex="-1"><a class="header-anchor" href="#conan包管理工具" aria-hidden="true">#</a> conan包管理工具</h1><h2 id="配置cmakelists-txt文件" tabindex="-1"><a class="header-anchor" href="#配置cmakelists-txt文件" aria-hidden="true">#</a> 配置CMakeLists.txt文件</h2><div class="language-cmake line-numbers-mode" data-ext="cmake"><pre class="language-cmake"><code><span class="token keyword">cmake_minimum_required</span><span class="token punctuation">(</span><span class="token property">VERSION</span> <span class="token number">3.26.0</span><span class="token punctuation">)</span>
