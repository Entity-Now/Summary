import{_ as e,o as i,c as a,f as n,e as d}from"./app.8d6eb341.js";const s={},l=d(`<h1 id="包管理工具-vcpkg" tabindex="-1"><a class="header-anchor" href="#包管理工具-vcpkg" aria-hidden="true">#</a> 包管理工具 vcpkg</h1><h2 id="入门" tabindex="-1"><a class="header-anchor" href="#入门" aria-hidden="true">#</a> 入门</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 首先就是clone项目
...
// 添加path变量-vcpkg的目录
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9);function c(r,t){return i(),a("div",null,[n(`
 * @作者: 14770137
 * @Date: 2022-09-22 15:18:35
`),l])}const u=e(s,[["render",c],["__file","vcpkg.html.vue"]]);export{u as default};
