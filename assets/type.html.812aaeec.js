import{_ as n,o as s,c as a,f as e,e as t}from"./app.8d6eb341.js";const p={},o=t(`<h1 id="类型别名" tabindex="-1"><a class="header-anchor" href="#类型别名" aria-hidden="true">#</a> 类型别名</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>type Name <span class="token operator">=</span> string<span class="token punctuation">;</span>
...
`),o])}const u=n(p,[["render",c],["__file","type.html.vue"]]);export{u as default};
