import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as t}from"./app-0bdf7b81.js";const e={},o=t(`<h1 id="创建数据库并简单使用" tabindex="-1"><a class="header-anchor" href="#创建数据库并简单使用" aria-hidden="true">#</a> 创建数据库并简单使用</h1><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">from</span> tortoise <span class="token keyword">import</span> Tortoise<span class="token punctuation">,</span> run_async
