import{_ as n,o as s,c as a,f as e,e as i}from"./app.8d6eb341.js";const l={},t=i(`<h1 id="scss" tabindex="-1"><a class="header-anchor" href="#scss" aria-hidden="true">#</a> scss</h1><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> node-sass
...
`),t])}const d=n(l,[["render",c],["__file","scss.html.vue"]]);export{d as default};
